...
Record architectural decisions in the Rust RFC style, adapted for a project whose decisions are earned through generational failure.
...
Gen 3v1 repeated mistakes that were already solved. The reason was always the same: the WHY behind decisions was not captured.
