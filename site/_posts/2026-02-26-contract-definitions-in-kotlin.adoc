...
excerpt: >
    Issue #4 complete. Domain model, messages, ports, and 10 MCP tools -- all in Kotlin. The design and the code now agree.
classes: wide
comments: true
hidden: false
search: true
...
The server runs on stdio and registers all 10 tools. All are *teapot stubs* -- callable, accepting valid input, returning placeholder responses.
