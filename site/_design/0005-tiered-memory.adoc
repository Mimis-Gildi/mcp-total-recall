...
Three sources. Seven commands. All writes flow through here. Every command carries a `TransactionContext` envelope for chain-of-custody tracing (link:/mcp-total-recall/design/0011-transaction-context/[Design F]).
