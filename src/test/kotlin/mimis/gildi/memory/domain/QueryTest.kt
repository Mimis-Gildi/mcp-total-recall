...
import mimis.gildi.memory.domain.message.Query
import mimis.gildi.memory.domain.message.ReflectQuery
import mimis.gildi.memory.domain.message.SearchQuery
